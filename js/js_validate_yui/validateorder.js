...
*/
	...
	function checkInvoicedOrder ()
	{
		var frm = document.OrderForm;
		var ordInvoiceWarning = frm.InvoiceWarning.value;
		
		if (ordInvoiceWarning == 'TRUE' && !confirm("Warning. You are modifying an invoiced order."))
		{
			return false; // 
		} else {
			return true;
	...
	function validateSubmit (e)
	{
		...
		if (!FIC_checkForm (this) || !addOrder (frm) || !checkShipDate () || !checkShipWeight () || !checkMinQuantities () || !checkInvoicedOrder ())  // ship weight is before minimum quantities because min qty doesn't correct ship weight
		{
